...
Live Hermes/Electron/YouTube behavior is tracked in `docs/release-tests/v3.141-playback-reliability.md`. Keep CI deterministic; do not pretend live webview behavior is covered by unit tests.

### Docked/Floating lifecycle

See `docs/release-tests/v3.141-docked-floating-lifecycle.md`. In-UI placement swaps and close/reopen are the signature feature; keep them regression-checked manually in real Hermes.

### Responsive & accessibility

Manual desktop-size/scaling/a11y checks live in `docs/release-tests/v3.141-responsive-ux-accessibility.md`. UI polish must not become a redesign.
