...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.9-blue" alt="Current v3.9">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.9.ps1
```

3. **Fully quit and reopen Hermes Desktop.** The pane title should show **YouTube v3.9 ★**.
