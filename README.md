...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.121-blue" alt="Current v3.121">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.121.ps1
```
...
```bash
chmod +x ./install-youtube-float-v3.121.sh
./install-youtube-float-v3.121.sh
```
...
4. Confirm the pane title shows **YouTube v3.121 ★**.
