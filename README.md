...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.12-blue" alt="Current v3.12">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.12.ps1
```

3. **Fully quit and reopen Hermes Desktop.** The pane title should show **YouTube v3.12 ★**.
