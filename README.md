...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.13-blue" alt="Current v3.13">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.13.ps1
```

3. **Fully quit and reopen Hermes Desktop.** The pane title should show **YouTube v3.13 ★**.
