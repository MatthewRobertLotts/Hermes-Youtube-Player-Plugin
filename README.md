...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.16-blue" alt="Current v3.16">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.16.ps1
```

3. **Fully quit and reopen Hermes Desktop.** The pane title should show **YouTube v3.16 ★**.
