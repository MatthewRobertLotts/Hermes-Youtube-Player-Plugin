...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.110-blue" alt="Current v3.110">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.110.ps1
```
...
```bash
chmod +x ./install-youtube-float-v3.110.sh
./install-youtube-float-v3.110.sh
```
...
4. Confirm the pane title shows **YouTube v3.110 ★**.
