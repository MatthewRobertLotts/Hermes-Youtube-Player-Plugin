...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Current-v3.70-blue" alt="Current v3.70">
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-youtube-float-v3.70.ps1
```

3. Fully quit and reopen Hermes Desktop.
4. Confirm the pane title shows **YouTube v3.70 ★**.
