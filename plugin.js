...
const VERSION = 'v3.70-compact-accountfix'
...
function YouTubeFloat({ pane = false } = {}) {
  ...
  openAccountPane = () => { accountPaneRequested = false; setLoginPane(true); setVolumeOpen(false); setHistoryPane(false); setPlaylistsPane(false) }
